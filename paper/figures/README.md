...
These figures were copied from the completed IEEE Access artifact outputs for manuscript use.

| Paper figure file | Source artifact path |
| --- | --- |
| `public_uncertainty_empirical_reference_coverage.png` | `bayesian-fpde-ieee-access-ieee_full/figures_ieee/public_uncertainty_empirical_reference_coverage.png` |
| `public_uncertainty_error_correlation.png` | `bayesian-fpde-ieee-access-ieee_full/figures_ieee/public_uncertainty_error_correlation.png` |
| `stability_spearman_boxplot.png` | `bayesian-fpde-ieee-access-ieee_full/figures_ieee/stability_spearman_boxplot.png` |
...
The main figures come from workflow run `27142484670`; the sensitivity figures come from workflow run `27142497585`. Both runs correspond to commit `1c24109f3ec412843703174550922b2f8e7ab72a`.
